...
import id.candlekeeper.skinpackml.databinding.ActivitySkinListBinding
import id.candlekeeper.skinpackml.ui.detailSkin.DetailSkinActivity
import id.candlekeeper.skinpackml.ui.detailSkin.DetailSkinActivity.Companion.DETAIL_SKINS
...
class SkinListActivity : AppCompatActivity(), OnItemClicked, View.OnClickListener {
    ...
    private fun initView() {
        ...
        when {
            heroes?.isAdditional == true -> {
                binding.tvSkin.text = heroes?.name
                viewModel.getAddSkins(heroes?.idHeroes!!).observe(this, skins)
            }
            isHideSkins == true -> {
